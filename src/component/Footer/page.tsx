...
function Footer() {
    return (
        <div className="bg-[#272F57] text-white py-10 px-4 sm:px-6  md:px-10 lg:px-12 flex items-center justify-center min-h-96">
            <div className="bg-white w-full max-w-7xl rounded-2xl p-6 sm:p-8 md:p-10 flex flex-col md:flex-row gap-6">
                ...
                <div className="md:w-[65%]">
                    <div className='w-full h-full bg-[#272F57] py-5 px-8 rounded-2xl'>
                        ...
                        <div className="w-full bg-[#EDEDED] mt-3 px-1 py-3 rounded-4xl">
                            <div className="flex flex-col sm:flex-row items-center  sm:gap-4">

                                <div className="w-12 h-12 bg-[#D9D9D9] rounded-full flex items-center justify-center shrink-0">
                                    <Link href="/">
                                        <Image
                                            src="/icons/mail.png"
                                            alt="Mail Icon"
                                ...
                                <form className="flex flex-1 w-full text-black" action="">
                                    <input
                                        type="email"
                                        placeholder="Enter your email address"
                                        className="flex-1 px-4  border-none py-2 rounded-l-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400"
                                    />
                                    <button className=" px-6 text-white bg-[#272F57] rounded-4xl cursor-pointer">Subscribe</button>
                                </form>
                            </div>
                        </div>
